...
| Automation | Ansible (see [toolkit-infrastructure](https://github.com/nulldeploy/toolkit-infrastructure)) |
...
**Ansible** — full deployment automation on a clean VPS: UFW, Docker, nginx, systemd, Node Exporter. One playbook run sets up the entire stack. See [toolkit-infrastructure](https://github.com/nulldeploy/toolkit-infrastructure).
